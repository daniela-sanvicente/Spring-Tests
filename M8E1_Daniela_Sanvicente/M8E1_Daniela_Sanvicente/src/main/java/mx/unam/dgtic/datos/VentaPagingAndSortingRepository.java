...
public interface VentaPagingAndSortingRepository extends PagingAndSortingRepository<Venta, Integer> {
//    //---------PagingAndSorting------
//    Page<Venta> findByCurpLike(String patron, Pageable pagina);
//
//    //DISTINCT
//    @Query(value = "SELECT DISTINCT a.nombre FROM Venta a")
//    Page<String> findDistinctNombre(Pageable pagina);
//
//    @Query(value = "SELECT DISTINCT a.paterno FROM Venta a")
