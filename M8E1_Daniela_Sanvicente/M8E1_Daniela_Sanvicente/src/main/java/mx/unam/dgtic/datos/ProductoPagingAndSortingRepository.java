...
public interface ProductoPagingAndSortingRepository extends PagingAndSortingRepository<Producto, Integer> {
//    //---------PagingAndSorting------
//    Page<Producto> findByCurpLike(String patron, Pageable pagina);
//
//    //DISTINCT
//    @Query(value = "SELECT DISTINCT a.nombre FROM Producto a")
//    Page<String> findDistinctNombre(Pageable pagina);
//
//    @Query(value = "SELECT DISTINCT a.paterno FROM Producto a")
